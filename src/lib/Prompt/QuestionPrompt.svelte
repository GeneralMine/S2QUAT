...
<Prompt bind:open on:close={closePrompt}>
	...
	<slot>
		<List>
			...
			{#if question.type === 'BOOLEAN' || question.type === 'BOOLEAN_TEXT' || question.type === 'CHECKBOX' || question.type === 'CHECKBOX_TEXT' || question.type === 'RADIOBUTTON' || question.type === 'RADIOBUTTON_TEXT'}
				<ListItemRow>
