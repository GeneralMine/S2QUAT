...
<div>
    <CardRow>
        <NumberCard title="Projects" value={cardFunctions.lengthOfKey(entityObject, "projects")} icon="projects" />
        <NumberCard title="Employees" value={cardFunctions.lengthOfKey(entityObject, "employees")} icon="employees" />
    </CardRow>
