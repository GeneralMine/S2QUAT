...
<div class="page">
    <CardRow>
        ...
        <NumberCard title="Durchschnittsalter" value={cardFunctions.averageOfKeys(entities, "age")} icon="average" />
        <PieCard
            title="Geschlechterverteilung"
            data={Object.values(cardFunctions.countBy(entities, "gender"))}
            labels={Object.keys(cardFunctions.countBy(entities, "gender"))}
            icon="questionAnswers"
        />
    </CardRow>
