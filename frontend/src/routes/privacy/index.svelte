	...
	<Surface title="Datenschutzerklärung">
		<div class="content">
			<p>
				...
				besonders hohen Stellenwert für die Geschäftsleitung der Fraunhofer IAO. Eine Nutzung der
				Internetseiten der Fraunhofer IAO ist grundsätzlich ohne jede Angabe personenbezogener Daten
			...
			<p>
				...
				der Datenschutz-Grundverordnung und in Übereinstimmung mit den für die Fraunhofer IAO
			...
			<p>
				Die Fraunhofer IAO hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
			...
			<p>
				Die Datenschutzerklärung der Fraunhofer IAO beruht auf den Begrifflichkeiten, die durch den
			...
			<h4>3. Cookies</h4>
			<p>
				Die Internetseiten der Fraunhofer IAO verwenden Cookies. Cookies sind Textdateien, welche
			...
			<p>
				Durch den Einsatz von Cookies kann die Fraunhofer IAO den Nutzern dieser Internetseite
			...
			<p>
				Die Internetseite der Fraunhofer IAO erfasst mit jedem Aufruf der Internetseite durch eine
			...
			<p>
				Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Fraunhofer IAO keine
				...
				anonym erhobenen Daten und Informationen werden durch die Fraunhofer IAO daher einerseits
			...
			<ul style="list-style: none;">
				...
				<li>
					...
					<p>
						...
						von personenbezogenen Daten, die bei der Fraunhofer IAO gespeichert sind, veranlassen
						möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
						Verantwortlichen wenden. Der Mitarbeiter der Fraunhofer IAO wird veranlassen, dass dem
						Löschverlangen unverzüglich nachgekommen wird.
					</p>

					<p>
						Wurden die personenbezogenen Daten von der Fraunhofer IAO öffentlich gemacht und ist
						unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
						personenbezogenen Daten verpflichtet, so trifft die Fraunhofer IAO unter
						...
						Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Fraunhofer IAO wird im
				...
				<li>
					...
					<p>
						...
						die Einschränkung von personenbezogenen Daten, die bei der Fraunhofer IAO gespeichert
						sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
						Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Fraunhofer IAO wird die
				...
				<li>
					...
					<p>
						...
						jederzeit an einen Mitarbeiter der Fraunhofer IAO wenden.
					</p>
				</li>
				<li>
					...
					<p>
						Die Fraunhofer IAO verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
					...
					<p>
						Verarbeitet die Fraunhofer IAO personenbezogene Daten, um Direktwerbung zu betreiben, so
						...
						betroffene Person gegenüber der Fraunhofer IAO der Verarbeitung für Zwecke der
						Direktwerbung, so wird die Fraunhofer IAO die personenbezogenen Daten nicht mehr für
					...
					<p>
						...
						bei der Fraunhofer IAO zu wissenschaftlichen oder historischen Forschungszwecken oder zu
					...
					<p>
						...
						Mitarbeiter der Fraunhofer IAO oder einen anderen Mitarbeiter wenden. Der betroffenen
				...
				<li>
					...
					<p>
						...
						ausdrücklicher Einwilligung der betroffenen Person, trifft die Fraunhofer IAO
