...
<div class="page">
    <CardRow>
        ...
        <NumberCard title="Bewertungsfelder" value={entities.filter((el) => el.depth === 0).length} icon="amount" />
        <NumberCard title="Qualitätsmerkmale" value={entities.filter((el) => el.depth === 1).length} icon="amount" />
        <NumberCard title="Qualitätsbestimmende Faktoren" value={entities.filter((el) => el.depth === 2).length} icon="amount" />
        <NumberCard title="Bewertungskriterien" value={entities.filter((el) => el.depth === 3).length} icon="amount" />
    </CardRow>
